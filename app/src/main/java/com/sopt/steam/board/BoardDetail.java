...
public class BoardDetail extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List<BoardDetailItem> item = new ArrayList<BoardDetailItem>();
        ListView listview = (ListView)findViewById(R.id.ListView1);

        item.add(new BoardDetailItem("닉네임1","내용1"));
        item.add(new BoardDetailItem("닉네임2","내용2"));
        item.add(new BoardDetailItem("닉네임3","내용3"));

        DetailAdater adapter = new DetailAdater(getApplicationContext(),item);
